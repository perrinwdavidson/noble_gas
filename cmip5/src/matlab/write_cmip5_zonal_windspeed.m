...
disp(append('Writing zonally-averaged interpolated CMIP5 model ', upper(variable), ' data to a netCDF file.'));
...
for iMod = 1 : 1 : NUMMOD
    ...
    variable_name = append(group_name, ' ', age, ' Zonally Averaged ', upper(variable)); 
